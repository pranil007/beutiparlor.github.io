...
?>
          ...
          <div class="col-md" style="padding-left: 150px">
             <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Links</h2>
              <ul class="list">
                        <li><a href="#"><img src="icons8-facebook-48.png" alt="social-icon"></a></li>
                        <li><a href="#"><img src="icons8-google-plus-48.png" alt="social-icon"></a></li>
                        <li><a href="#"><img src="icons8-linkedin-48.png" alt="social-icon"></a></li>
                        <li><a href="#"><img src="icons8-pinterest-48.png" alt="social-icon"></a></li>
                        <li><a href="#"><img src="instagram.png" alt="social-icon"></a></li>
                        <li><a href="#"><img src="youtube.png" alt="social-icon"></a></li>
